...
/*     else if(val=='2'){
         $.post('report-leave-bank-salary.php', {
         }, function (data) {
             $('.btntableft').removeClass('activeBtn');
             $('.btntableft').addClass('tabbutton');
             $('#dispfrm').html(data);
         ...
         $.post('report-leave-transfer.php', {
         }, function (data) {
             $('.btntableft').removeClass('activeBtn');
             $('.btntableft').addClass('tabbutton');
             $('#dispfrm').html(data);
         ...
         $.post('report-leave-emerson-transfer.php', {
         }, function (data) {
             $('.btntableft').removeClass('activeBtn');
             $('.btntableft').addClass('tabbutton');
             $('#dispfrm').html(data);
         ...
         $.post('report-leave-neft-letter.php', {
         }, function (data) {
             $('.btntableft').removeClass('activeBtn');
             $('.btntableft').addClass('tabbutton');
             $('#dispfrm').html(data);
         ...
         $.post('report-leave-cheque-list.php', {
         }, function (data) {
             $('.btntableft').removeClass('activeBtn');
             $('.btntableft').addClass('tabbutton');
             $('#dispfrm').html(data);
...
<div class="twelve mobicenter innerbg">
    <div class="row">
        <div class="twelve" id="margin1"> <h3>Leave Detail List</h3></div>
...
<!--                <button  class="btnclass" onclick="emppdfdownload();">PDF Download</button>-->
        ...
        <div class="twelve" id="margin1">
            ...
            <ul style="list-style: none;background-color: #f7f7f7;">
                <li> <span class="btntableft tabbutton" onclick="diplayform(1);" id="1">List </span></li>
