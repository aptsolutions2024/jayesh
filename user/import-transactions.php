...
<div class="twelve mobicenter innerbg">
    <div class="row">
        ...
        <div class="clearFix"></div>
        <br/>
        <form method="post"  name="frm" action="/import_transactions_process"   enctype="multipart/form-data" onsubmit="return validation();">
        <div class="twelve " >
 ...
 <div class="twelve columns" >
            <div class="seven padd0 columns">
                ...
                <a class="switch"  href="/export_emp_transactions">1. Generate Blank file from Employee Master </a>
...
<div class="twelve columns" >
            <div class="seven padd0 columns">
                <!--                <a class="switch" href="../transactions.csv" download>Transactions Export to Blank CSV File </a><br/>-->
                <!--<a class="switch" href="export-emp-transactions.php">Export Data / Blank Excel Format for importing days details </a>-->
                <!--a class="switch" href="/export_trandays_transactions">2. Export Entered Days details from Transaction File. </a-->
