...
<div class="twelve mobicenter innerbg">
    <div class="row">
        <div class="twelve padd0" id="margin1"> <h3>Employee Deduct Export </h3></div>
        <div class="clearFix"></div>
        <br/>
        <form method="post"  name="frm" action="/export_deduct"   enctype="multipart/form-data" onsubmit="return validation();" >
