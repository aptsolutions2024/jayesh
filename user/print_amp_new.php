...
if ($frdt==$current_month)
	{$tab = "tran_emerson_bill".$tab_client;$frdt=$current_month;}
else
...
echo "
<div align='center'><h2>AMP Summary Report For ".date("M Y ", strtotime($frdt))."</h2></div>
...
while ($row = mysql_fetch_array($res1)){
	...
	echo "<tr><td>".$srno."</td>";
	$srno++;
	echo "<td align= 'right'>".substr($row['dept_name'],0,4)."</td>";
	echo "<td align= 'right'>".$row['dept_name']."</td>";
	}
	else
