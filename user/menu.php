...
<div class="row" >
    ...
    <div  class="contenttext"  id='cssmenus'>
		...
		if($ltype !=3){?>
            ...
            <li class="has-sub"><a href="javascript:void()"><span>Salary</span></a>
                <ul>
                    ...
                    <li <?php if($page=='import-transactions.php'){ ?>class='active'<?php } ?>><a href='/import_transactions'  <?php if($page=='tran-leave.php'){ ?>class='noborder'<?php } ?> ><span>Import Days Details </span></a></li>
                    <li <?php if($page=='tran-calculation.php'){ ?>class='active'<?php } ?>><a href='/tran_calculation' <?php if($page=='import-transactions.php'){ ?>class='noborder'<?php } ?>  ><span>Calculation</span></a></li>
					 ...
					 <!--li <?php if($page=='/import-transactions-days.php'){ ?>class='active'<?php } ?>><a href='/import-transactions-days'  <?php if($page=='import-transactions-days.php'){ ?>class='noborder'<?php } ?> ><span>Import DayWise Details</span></a></li-->
		...
		if($ltype ==3){ if($_SESSION['comp_id']==2) {$_SESSION['log_id']=3;}else {$_SESSION['log_id']=2;}}?>
            ...
            <li class='has-sub <?php if($page=='report-salary.php' || $page=='report-bank.php'){ ?>active<?php } ?>'><a href='javascript:void(0);' ><span>Reports</span></a>
                <ul>
                    ...
                    <li <?php if($page=='report-bank.php'  ){ ?>class='active'<?php } ?>style="display:none;"><a <?php if($page=='report-pf.php'){ ?>class='noborder'<?php } ?> href='/report_bank'><span>Bank</span></a></li>
                    ...
                    <li <?php if($page=='report-advances.php'){ ?>class='active'<?php } ?> style="display:none;"> <a <?php if($page=='report-advances.php'){ ?>class='noborder'<?php } ?>  href='/report_advances' ><span>Advances</span></a></li>
					...
					<li <?php if($page=='letters.php'){ ?>class='active'<?php } ?>style="display:none;"><a href='/letters' <?php if($page=='letters.php'){ ?>class='noborder'<?php } ?> ><span>Letter</span></a></li>
					
					<li <?php if($page=='report-gst-bill.php'){ ?>class='active'<?php } ?>style="display:none;" ><a href='/report_gst_bill'  <?php if($page=='report-gst-bill.php'){ ?>class='noborder'<?php } ?>><span>GST BILL </span></a></li>
		...
		<?php if($ltype !=3){?>
			...
			<li class="has-sub" style = "display:none;">  <a href="javascript:void()"><span>Leave</span></a>
			<ul>
				...
				<li <?php if($page=='leave-detail_reports.php'){ ?>class='active'<?php } ?>><a href="/leave_detail_reports" class='noborder'><span>Reports</span></a></li>
			            ...
			            <li class='has-sub'style = "display:none;"><a href='javascript:void(0);' ><span>Income  Tax</span></a>
                <ul>
