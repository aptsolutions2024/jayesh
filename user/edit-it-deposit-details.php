...
$result11 = $userObj->displayitdepositdetails($id,$comp_id,$user_id);
$result1 = $userObj->displayitdeposit($comp_id,$user_id);
/* pagination starts */
...
<head>
  ...
  <link rel="stylesheet" href="../css/jquery-ui.css">
    ...
    function deleterow(id) {
        if(confirm('Are you You Sure want to delete this Field?')) {
            $.post('/delete_it_deposit_details_process', {
                'id': id
            }, function (data) {
  ...
  function update() {
      clear();
      $('#success1').hide();
        var salmonth=document.getElementById("salmonth11").value;
      ...
      if(salmonth==''){
          ...
          $('#ad1error').html("Please Enter the Challan No");
          $('#ad1error').show();
          document.getElementById("add1").focus();
          $("#success").hide();
      }
      else if(deposite_date=='') {
          $('#esierror').html("Please Enter the Deposit Date");
          $('#esierror').show();
          document.getElementById("esicode").focus();
          $("#success").hide();
      }
      else if(status=='') {
          $('#pferror').html("Please Enter the Oltas Status");
          $('#pferror').show();
          document.getElementById("pfcode").focus();
          $("#success").hide();
      }
     else {
              $.post('/update_it_deposit_details_process',{
                  'salmonth':salmonth,
                  'chno':chno,
                  'id':id,
                  ...
                  $("#success1").html('Record Update Successfully<br/><br/>');
                   // $("#success1").html(data); 
                  $("#success1").show();
                  $("#form").trigger('reset');
                  $("#dispaly").load(document.URL +  ' #dispaly');
...
<div class="twelve mobicenter innerbg">
    <div class="row">
        ...
        <div class="twelve" id="margin1">
            ...
            <input type="hidden" name="id" id="id" value="<?php echo $result11['id']; ?>">
            <div class="three padd0 columns">
                <input type="text" name="salmonth" id="salmonth11" placeholder="Sal Month" class="textclass" value="<?php echo date("d-m-Y", strtotime($result11['sal_month'])); ?>">
                <input type="hidden" id="data" name="hiddensalmonth" value="">
            ...
            <div class="three padd0 columns">
                <input type="text" name="chno" id="chno" placeholder="Challan No" class="textclass" value="<?php echo $result11['challan_no']; ?>">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="deposite_date" id="deposite_date" placeholder="Deposit Date" class="textclass" value="<?php echo date("d-m-Y", strtotime($result11['deposite_date'])); ?>">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="status" id="status" placeholder="Oltas Status" class="textclass" value="<?php echo $result11['oltas_status']; ?>">
            </div>
            ...
            <div class="six padd0 columns" id="margin1">
                &nbsp;
            </div>
            <div class="clearFix"></div>
