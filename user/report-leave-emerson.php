...
<div class="twelve mobicenter">
    <div class="row">
        ...
        <div class="clearFix"></div>
        <form method="post"  id="form" action="/report_leave_bank_emerson" onsubmit="return validation()">
		...
		<div class="three padd0 columns">
            ...
            <div class="four padd0 columns">
			<div class="four  columns pdl10p">Payment From Date</div>
            ...
            <div class="four  padd0 columns">
				<div class="four  columns pdl10p">Payment To Date</div>
