...
<tr colspan=<?php echo $cnt+1; ?>>
	<th class="th" colspan="<?php echo $cnt+1;?>"><p align="left" style="display:inline; float: right;">&nbsp;</p>Emerson Bill On : <?php echo date('d/M/Y',strtotime($resclt['frdt'])). " (".$resclt['client_name'].")";?></th>
...
<tr>
		...
		<table width="100%">
			...
			<tr>
			<td><?php echo $j++;?></td>
			<td><?php echo substr($arr[$i]['desg_name'], strpos(substr($arr[$i]['desg_name'],0), "-")+2,99);?></td>
