    ...
    <script>
        ...
        function diplayform(val){
            ...
            if(val=='1'){
                ...
                $.post('/report_pf_statement_summary', {
                }, function(data) {
                    $('#dispfrm').html(data);
                    $('.btntableft').removeClass('activeBtn');
                    $('.btntableft').addClass('tabbutton');
    ...
    <div class="row">
        ...
        <div class="twelve" id="margin1">
            ...
            <ul style="list-style: none;background-color: #f7f7f7;">
                ...
                <!--li> <span class="btntableft tabbutton" onclick="diplayform(7);" id="7">Form 9</span></li-->
