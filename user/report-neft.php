...
<div class="twelve mobicenter">
    <div class="row">
        <div class="twelve"><h3>NEFT</h3></div>
        <div class="clearFix"></div>
        <form method="post"  id="form" action="/export_leave_bank_neft_format"   onsubmit="return validation()">
		...
		<!--	<div class="one padd0 columns">
            ...
            <div class="two padd0 columns">
							<input type="hidden" name="sakal_type" value="S">
