...
<div class="twelve mobicenter">
    <div class="row">
        <div class="twelve"><h3>LEAVE NEFT Letter</h3></div>
        <div class="clearFix"></div>
        <form method="post"  id="form" action="/report_leave_neft_letter"   >
        <div class="twelve" id="margin1">
            <div class="three padd0 columns">
                <span class="labelclass1">Parent :</span>
            </div>
            <div class="five padd10 columns">
            ...
            <div class="clearFix"></div>
			 ...
			 <div class="three padd0 columns"> Payment Date :	</div>
				<div class="two padd0 columns"><input type="text" name="payment_date" id="payment_date" class="textclass">
