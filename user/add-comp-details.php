...
$result1 = $userObj->showCompdetails($comp_id,$user_id);
 ...
 //             $("#success").hide();
   //       }
            ...
            if(data!=0){
                    ...
                    $("#error1").html('Record already exist<br/>');
					$("#error1").html(data);
                    ...
                    $("#error1").hide();
                     $("#success").html('Record Inserted Successfully<br/>');
                     $("#success").show();
                     $("#form").trigger('reset');
                     $("#dispaly").load(document.URL + ' #dispaly');
                }
...
<div class="twelve mobicenter innerbg">
    <div class="row">
        ...
        <div class="twelve" id="margin1">
            ...
            <div class="twelve padd0 columns errorclass hidecontent" id="error1">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="fdate" id="fdate" placeholder="Form Date" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="tdate" id="tdate" placeholder="To Date" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="assyr" id="assyr" placeholder="Assessment Year" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="tdsc" id="tdsc" placeholder="TDS Circle" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="authp" id="authp" placeholder="Authorised Person" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="authd" id="authd" placeholder="Authorised Designation" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="authmn" id="authmn" placeholder="Auth.Middle Name " class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="bcrc" id="bcrc" placeholder="BCR Code" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qcn1" id="qcn1" placeholder="Q1 Challan No" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qap1" id="qap1" placeholder="Q1 Amount Paid" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qade1" id="qade1" placeholder="Q1 Amount Deducted" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qadp1" id="qadp1" placeholder="Q1 Amount Deposited" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qcn2" id="qcn2" placeholder="Q2 Challan No" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qap2" id="qap2" placeholder="Q2 Amount Paid" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qade2" id="qade2" placeholder="Q2 Amount Deducted" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qadp2" id="qadp2" placeholder="Q2 Amount Deposited" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qcn3" id="qcn3" placeholder="Q3 Challan No" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qap3" id="qap3" placeholder="Q3 Amount Paid" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qade3" id="qade3" placeholder="Q3 Amount Deducted" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qadp3" id="qadp3" placeholder="Q3 Amount Deposited" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qcn4" id="qcn4" placeholder="Q4 Challan No" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qap4" id="qap4" placeholder="Q4 Amount Paid" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qade4" id="qade4" placeholder="Q4 Amount Deducted" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="qadp4" id="qadp4" placeholder="Q4 Amount Deposited" class="textclass">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="text" name="prdate" id="prdate" placeholder="Printing Date" class="textclass">
