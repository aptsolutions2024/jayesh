...
<div class="twelve mobicenter">
    <div class="row">
        <div class="twelve"><h3>Leave Register Voucher</h3></div>
        <div class="clearFix"></div>
        <form method="post"  name="form" id="form" action="/report-leave-voucher.php?client=<?php echo $client ?>" method="post" onsubmit="return validation()">
		...
		<!-- <div class="three padd0 columns">
         ...
         -->   <div class="four padd0 columns">
			<div class="five  columns pdl10p">Payment Date</div>
				<div class="seven padd0 columns">
			 <select name="paymentdate" class="textclass" id="frdt1" >
		   ...
		   <?php }?>
			...
			<!--<div class="seven padd0 columns"><input type="text" name="paymentdate" class="textclass" id="frdt1" placeholder="YYYY-MM-DD"> <span class="errorclass hidecontent" id="from_dateerror"></span></div>
