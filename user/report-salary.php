...
<head>
 ...
 function diplayform(val){
     ...
     if(val=='1'){
         ...
         $.post('/report_email_payslip', {}, function (data) {
             $('.btntableft').removeClass('activeBtn');
             $('.btntableft').addClass('tabbutton');
             $('#dispfrm').html(data);
             $('#' + val).addClass('activeBtn');
    ...
    <div class="row">
        ...
        <div class="twelve" id="margin1">
            ...
            <div class="five columns">
                <div id="showPrevious" class="hidecontent">
                    ...
                    <div class="one paddt0 columns" align="center" id = "prv_to" >
                        <span> To</span>
                    </div>
                    <div class="four paddt0  columns" id = "prv_todate">
        ...
        <div class="twelve" id="margin1">
            ...
            <ul style="list-style: none;background-color: #f7f7f7;">
                ...
                <li> <span class="btntableft tabbutton" onclick="diplayform(2);" id="2" style="display:none;">Pay Sheet</span></li>
               ...
               <li> <span class="btntableft tabbutton" onclick="diplayform(6);" id="6"  style="display:none;">Dept.Pay Sheet</span></li>
