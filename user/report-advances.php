    ...
    <div class="row">
        ...
        <div class="twelve" id="margin1">
            ...
            <ul style="list-style: none;background-color: #f7f7f7;">
                <li> <span class="btntableft tabbutton" onclick="diplayform(1);" id="1">Advance List</span></li>
