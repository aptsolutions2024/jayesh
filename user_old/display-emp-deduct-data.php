...
<?php
$res = $common->getEmpDeductData($destid,$clientid);
...
<input type="hidden" name="emp_de_id[]" value="<?php echo $row['emp_deduct_id'];?>">
	...
	<div class="twelve bgColor2" >
        ...
        <div class="two columns">
            <input class="textclass" type="text" name="texta[]" id="text1<?php echo $row['emp_deduct_id'];?>" value="<?php echo $row[0];?>" style="width: 100%;">
        </div>
        ...
        <div class="three columns">
            <input class="textclass" type="text" name="textc[]" id="text3<?php echo $row['emp_deduct_id'];?>" value="<?php echo $row[2];?>">
        </div>
