...
<head>
  ...
  <title>Salary | Income Heads</title>
  <!-- Included CSS Files -->
  ...
  <link rel="stylesheet" href="../css/style.css">
    ...
    <script>
        ...
        function saveIncomehead(){
            var name=document.getElementById("ihname").value;
            ...
            else if(!isNaN(name))
            {
                ...
                $.post('/add_mast_incomehead_process',{
                    'name':name
                },function(data){
                    $('#error').hide();
...
<div class="twelve mobicenter innerbg">
    <div class="row">
        <div class="twelve" id="margin1"><h3>Income Heads</h3><a href="/exportallincomeheads"><input type="button" name="submit"  value="Export" class="btnclass" ></a></div>
        <div class="clearFix"></div>
        ...
        <div class="twelve" id="margin1">
            ...
            <div class="four padd0 columns">
                <input type="text" name="ihname" id="ihname" placeholder="Income Head Name" class="textclass" onkeyup="searchIncom(this.value);" autocomplete="off">
                <div id="display" class="dispnamedrop"></div>
                <span class="errorclass hidecontent" id="iherror"></span>
            </div>
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="button" name="submit" id="submit" value="Save" class="btnclass" onclick="saveIncomehead();">
            </div>
...
<script> function searchIncom(val){
        $('#display').show();
        $.post('/search_income', {
            'name': val
        }, function (data) {
