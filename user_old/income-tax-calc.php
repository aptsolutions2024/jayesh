 ...
 $mhraex3 = 0; 
  ...
  // echo "<br>";
	...
	$row21= mysql_fetch_array($row2);
	 //echo "1. hraPaid : ".  round($row21['hrapaid'],0);

   //  echo "<br>2. hraPaid Pm : ";
  ...
  /*   $sql1= "SELECT sum(std_amt) as amount FROM emp_income  WHERE   emp_id = '".$row11["emp_id"]."' and head_id in (select mast_income_heads_id from mast_income_heads  where  (`income_heads_name` LIKE '%BASIC%' or `income_heads_name` LIKE '%D.A.%' OR `income_heads_name` LIKE '%wage%' ) and comp_id = '".$comp_id."'  )";
	...
	$row3 = mysql_fetch_array($row2);
	 $mhraex3 = $row21['hrapaid']-($row3['amount']*.1*12);
	*/
...
$sql1 = "insert into  tab_itcalc1".$user_id . "(`year`, `emp_id`, gross_salary) select  '$year',emp_id, (tot_bonus_amt+tot_exgratia_amt) as gross_salary  from bonus where  from_date='$bonus_fromdate' AND todate='$bonus_todate'  ".$Empidval;
...
echo "<br>";
 ...
 $row= mysql_query($sql1);
  ...
  $sql="select  `year`, `emp_id`, sum(`gross_salary`) as gross_salary , `conveyance`, `hra`, `prof_tax`, `pf`, `esi`, `proj_months`, `sal_month`, `sal_count`, `incometax` from tab_itcalc1".$user_id ." where year='".$year."' ".$Empidval . " group by emp_id";
 $row= mysql_query($sql);
...
while($res=mysql_fetch_array($row41)){
   ...
   echo  $sql44 = "update tab_it1_".$user_id ." set col_122_2 =".$tax_val." ,col_12_2=".$tax_val." where  year = '".$res['year'] ."' and emp_id = '". $res['emp_id']."' ";
 ...
 echo $sql4="update tab_it1_".$user_id  ."  set col_121_2=col_12_2,col_122_2 =0 where  col_12_2 <= 2500  and  col_11_2 <=350000 and  year='".$year."'".$Empidval;  
//echo $sql4="update tab_it1_".$user_id  ."  set col_122_2 =0 where  col_12_2 <= 2500  and  col_11_2 <=350000 and  year='".$year."'".$Empidval;
//$row4= mysql_query($sql4);



 //echo $sql4="update tab_it1_".$user_id  ."  set    col_122_2=col_12_2-2500 where col_12_2 > 2500  and col_11_2 <=350000 and   year='".$year."'".$Empidval;
 echo $sql4="update tab_it1_".$user_id  ."  set  col_121_2=2500,   col_122_2=col_12_2-2500 where col_12_2 > 2500  and col_11_2 <=350000 and   year='".$year."'".$Empidval;
$row4= mysql_query($sql4); 
