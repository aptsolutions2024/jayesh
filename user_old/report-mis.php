...
<div class="twelve mobicenter innerbg">
    <div class="row">
        <div class="twelve" id="margin1"> <h3>MIS Reports List</h3></div>
...
<!--                <button  class="btnclass" onclick="emppdfdownload();">PDF Download</button>-->
        ...
        <div class="twelve" id="margin1">
            ...
            <ul style="list-style: none;background-color: #f7f7f7;">
                <li> <span class="btntableft tabbutton" onclick="diplayform(1);" id="1">ESI-PF Details </span></li>
				<li> <span class="btntableft tabbutton" onclick="diplayform(2);" id="2">Periodic Random Pay Slip </span></li>
				<li> <span class="btntableft tabbutton" onclick="diplayform(3);" id="3">Muster Roll </span></li>
				<li> <span class="btntableft tabbutton" onclick="diplayform(4);" id="4">Paysheet </span></li>
				<li> <span class="btntableft tabbutton" onclick="diplayform(5);" id="5">Form 3A </span></li>
				<li> <span class="btntableft tabbutton" onclick="diplayform(6);" id="6">Days Details </span></li>
				<li> <span class="btntableft tabbutton" onclick="diplayform(7);" id="7">Gratuity </span></li>
			</ul>
