...
<head>
  ...
  <title>Bonus 111| Cheque Printing</title>
  <!-- Included CSS Files -->
...
<div class="twelve mobicenter">
    <div class="row">
        <div class="twelve"><h3>Bonus Cheque Printing</h3></div>
        <div class="clearFix"></div>
...
function editsingle(id,srno){
	...
	function printManual(){
		...
		window.location.href="check_print_pre?nameman="+nameman+"&amountman="+amountman+"&checkdate="+chkdt;
	}
</script>
