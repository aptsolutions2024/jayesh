...
<div class="twelve mobicenter">
    <div class="row">
        <div class="twelve"><h3>Bonus Transfer </h3></div>
        <div class="clearFix"></div>
        <form method="post"  id="form" action="/report_leave_bank-salary" >
        <div class="twelve" id="margin1">
            ...
            <div class="clearFix"></div>
			 ...
			 <div class="three padd10 columns"><span class="labelclass1"> Date :</span>	</div>
			  ...
			  <span id="checkno" >
			  <div class="three padd10 columns"> Cheque no :	</div>
