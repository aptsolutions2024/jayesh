...
<div class="twelve mobicenter">
    <div class="row">
        <div class="twelve"><h3>Salary Bank</h3></div>
        <div class="clearFix"></div>
        <form method="post"  id="form" action="/report_leave_bank_emerson">
        <div class="twelve" id="margin1">
            <div class="three padd10 columns">
                <span class="labelclass1">Parent :</span>
            </div>
            <div class="two padd0 columns">
       			<input type="hidden" name="pay_type" value="B">
         <input type="radio" name="emp" value="Parent" onclick="changeemp(this.value);" >Yes
            ...
            <div class="clearFix"></div>
			 ...
			 <div class="three padd0 columns"> IDBI Cheque Date :	</div>
			  ...
			  <span id="checkno" >
			  <div class="three padd0 columns"> IDBI Cheque no :	</div>
			 ...
			 <div class="three padd0 columns"> Karad Urban Ch.Date :	</div>
				<div class="two padd0 columns"><input type="text" name="checkdate_K" id="checkdate_K" class="textclass">
				 <span class="errorclass hidecontent" id="checkdateerror1"></span>
				</div>
				<div class="five padd0 columns"></div>
				 <div class="one  padd0 columns">  </div>
			  ...
			  <span id="checkno" >
			  <div class="three padd0 columns"> Karad Urban Ch.Cheque no :	</div>
				<div class="two padd0 columns"><input type="text" name="checkn_K" id="checkn_K" class="textclass" onkeyup="setcheckno(this.value)">
				 <span class="errorclass hidecontent" id="checknerror1"></span>
				</div>
				<div class="five padd0 columns"></div>
				 <div class="one  padd0 columns">  </div>
			...
			<div class="clearFix">&nbsp;</div>
             ...
             <div class="three padd0 columns" id="margin0">
            </div>
