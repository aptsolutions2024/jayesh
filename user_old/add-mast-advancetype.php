...
<head>
  ...
  <title>Salary | Advance Type</title>
  <!-- Included CSS Files -->
  ...
  <link rel="stylesheet" href="../css/style.css">
    ...
    <script>
        ...
        function saveAdvancetype(){
            var name=document.getElementById("adname").value;
            clear();
            if(name==''){
                $('#aderror').html("Please Enter the Advance type Name");
                $('#aderror').show();
            ...
            {
                $('#aderror').html("Please Enter the Valid Advance type Name");
                $('#aderror').show();
                document.getElementById("adname").focus();
                $("#success").hide();
            }
            else{
                $.post('add_mast_advancetype_process',{
                    'name':name
                },function(data){
...
<div class="twelve mobicenter innerbg">
    <div class="row">
        <div class="twelve" id="margin1"><h3>Advance Type</h3><a href="/exportalladvancetype"><input type="button" name="submit"  value="Export" class="btnclass" ></a></div>
        <div class="clearFix"></div>
        ...
        <div class="twelve" id="margin1">
            ...
            <div class="four padd0 columns">
                <input type="text" name="adname" id="adname" placeholder="Advance Type Name" class="textclass" onkeyup="searchAdvanceType(this.value);" autocomplete="off">
            ...
            <div class="three padd0 columns" id="margin1">
                <input type="button" name="submit" id="submit" value="Save" class="btnclass" onclick="saveAdvancetype();">
            </div>
...
<script> function searchAdvanceType(val){
    
        $('#display').show();
        $.post('/search_advancetype', {
            'name': val
        }, function (data) {
            $('#display').html(data);
            //$('#searching').show();
