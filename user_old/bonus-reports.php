...
function emppdfdownload(){
 ...
 function diplayform(val){
   if(val=='1'){
         $.post('/report_bonus_cheque_printing', {
         }, function (data) {
             $('#dispfrm').html(data);
         ...
         $.post('/report_emerson_transfer_bonus', {
         }, function (data) {
             $('.btntableft').removeClass('activeBtn');
             $('.btntableft').addClass('tabbutton');
             $('#dispfrm').html(data);
