    ...
    <script type="text/javascript" src="../js/jquery-ui.js"></script>
        ...
        function diplayform(val){
            if(val=='1'){
                ...
                $.post('report_esi_summery_statement', {
					'mon':month,
					'frdt':frdt,
					'todt':todt
                }, function (data) {
			...
			if(val=='6'){
                ...
                $.post('/report_without_esi_summery_statement', {
					'mon':month,
					'frdt':frdt,
					'todt':todt
                }, function (data) {
			...
			if(val=='7'){
                ...
                $.post('/report_contribution_esi_summery_statement', {
					'mon':month,
					'frdt':frdt,
					'todt':todt
                }, function (data) {
...
<div class="twelve mobicenter innerbg">
    <div class="row">
        <div class="twelve" id="margin1"> <h3>E.S.I Reports List</h3></div>
        ...
        <div class="twelve" id="margin1">
            ...
            <ul style="list-style: none;background-color: #f7f7f7;">
                <li> <span class="btntableft tabbutton" onclick="diplayform(1);" id="1">ESI Statement</span></li>
				<li> <span class="btntableft tabbutton" onclick="diplayform(5);" id="5">ESI Summery</span></li>
				<li> <span class="btntableft tabbutton" onclick="diplayform(6);" id="6">Without Esi  Employee</span></li>
				<li> <span class="btntableft tabbutton" onclick="diplayform(7);" id="7">Contribution Sheet</span></li>
                <li> <span class="btntableft tabbutton" onclick="diplayform(2);" id="2">Excel Export</span></li>
