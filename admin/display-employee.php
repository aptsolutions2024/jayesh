...
$userObj=new user();
$id=$_REQUEST['id'];
$rowsemp=$userObj->showEployeedetails($id);
$rowsincome=$userObj->showEployeeincome($id);
$rowsdeduct=$userObj->showEployeededuct($id);
$rowsleave=$userObj->showEployeeleave($id);
$rowsadnavcen=$userObj->showEployeeadnavcen($id);
...
/*    function selbank(val){
    ...
    function deleteeirow(id) {
        if(confirm('Are you You Sure want to delete this Field?')) {
            $.get('delete-emp-income-process.php', {
                'id': id
            },function(data){
                refreshIncome('<?php echo $id; ?>');
    ...
    function deletederow(id) {
        if(confirm('Are you You Sure want to delete this Field?')) {
            $.get('delete-emp-deduct-process.php', {
                'id': id
            },function(data){
                refreshDeduct('<?php echo $id; ?>');
      ...
      clearemp();
       ...
       /* else if(emailtext=='') {
        ...
        /*else if(phone=='') {
            ...
            $.get('update-employee-process.php',{
                'fname':fname,
                'mname':mname,
                'lname':lname,
                'lodate':lodate,
 ...
 function refreshconutIncome(id){
        ...
        $.get('display-emp-income-totalcont.php',{
            'id':id
        },function(data){
   ...
   function insertIncome(){
       ...
       else if(amt!=null)
       {
           ...
           $.get('employee-income-process.php',{
               'empid':empid,
               'caltype':caltype,
               'incomeid':incomeid,
               'inremark':inremark,
    ...
    function refreshIncome(id){
        var view=2;
        $.get('display-emp-income-details.php',{
        'id':id,
        'view':view
        },function(data){
    ...
    function insertDeduct(){
        ...
        else if(amt!=null)
        {
            ...
            $.get('employee-deduct-process.php',{
                'empid':empid,
                'selbank':selbank,
                'decaltype':decaltype,
    ...
    function refreshDeduct(id){
        var view=2;
        $.get('display-emp-deduct-details.php',{
            'id':id,
            'view':view
        },function(data){
    ...
    function refreshLeave(id){
        var view=2;
        $.get('display-emp-leave-details.php',{
            'id':id,
            'view':view
        },function(data){
    ...
    function deletelerow(id) {
        if(confirm('Are you You Sure want to delete this Field?')) {
            $.get('delete-emp-leave-process.php', {
                'id': id
            },function(data){
                refreshLeave('<?php echo $id; ?>');
    ...
    function insertLeave(){
       ...
       if(ob=='') {
            ...
            $.get('employee-leave-process.php',{
                'ob':ob,
                'lfdate':lfdate,
                'lt':lt,
                'empid':empid,
    ...
    function refreshAdvances(id){
        var view=2;
        $.get('display-emp-advances-details.php',{
                'id':id,
                'view':view
            },function(data){
    ...
    function deleteadrow(id) {
        if(confirm('Are you You Sure want to delete this Field?')) {
            $.get('delete-emp-advances-process.php', {
                'id': id
            },function(data){
                refreshAdvances('<?php echo $id; ?>');
    ...
    function updateAdnavcen() {
        ...
        if(advtype=='') {
            ...
            $.get('update-advances-process.php', {
                'advamt': advamt,
                'empid': empid,
                'id': id,
                'advdate':advdate,
   ...
   function insertAdnavcen(){
        ...
        if(advtype=='') {
            ...
            $.get('employee-advances-process.php',{
                'advamt':advamt,
                'empid':empid,
                'advdate':advdate,
                'advtype':advtype,
