        ...
        <div class="twelve padd0 columns" >
            ...
            <div class="six padd0 columns mobicenter text-left " id="container1">
              ...
              <!--  <div class="logo" ><img src="../images/JSM-logo.jpg" width="50px" height="50px" align="absmiddle">-->
                    <div class="logo" ><b><?php
                    $co_id=$_SESSION['comp_id'];
                    $rowcomp=$adminObj->displayCompany($co_id);
                    echo ' <span class="heade head1" style="font-size:20px;color: black; float:"right">&nbsp;'.$rowcomp['comp_name'].' </span>'; ?><br />
                    <span class="heade head2" style="margin-left:10px;margin-top:0px;position:absolute;font-size:20px;color: black;"> <?php echo $_SESSION['reporttitle']; ?></span><b></div>
            ...
            <div class="six padd0 columns text-right text-center" id="container3">
                ...
                <div class="mobicenter text-right"  >
                    <span  class="heade" style="font-size:14px;color: black;float:'right';"><?php echo $_SESSION['client_name']; ?> &nbsp;&nbsp;&nbsp;&nbsp;<br/></span><span  class="heade" style="font-size:20px;color: black;"> <?php// echo date('d-m-Y');?>&nbsp;&nbsp;&nbsp;&nbsp;</span>
