...
<div class="twelve mobicenter">
    <div class="row">
        <div class="twelve"><h3>Cheque Printing</h3></div>
        <div class="clearFix"></div>
        ...
        <div class="twelve" id="margin1">
            ...
            <div class="clearFix">&nbsp;</div>
			 <div class="four padd0 columns">
			<div class="four padd0 columns pdl10p">From Date</div>
		...
		<div class="clearFix">&nbsp;</div>
			  ...
			  <span id="manualchequeprint" style="display:none">
				...
				<div class="eight padd0 columns"><input type="text" name="amount" id="amountman" class="textclass">
				 ...
				 <span id="date" >
				 <div class="four padd0 columns">
			  <div class="four padd0 columns pdl10p"> Date :	</div>
				<div class="eight padd0 columns"><input type="text" name="checkdate" id="checkdate" class="textclass">
			  ...
			  <span id="checkno" >
			  <div class="four padd0 columns">
			  <div class="four  columns pdl10p"> Cheque no :	</div>
				<div class="eight padd0 columns"><input type="text" name="checkn" id="checkn" class="textclass" onkeyup="setcheckno(this.value)">
