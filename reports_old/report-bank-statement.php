...
<?php 
while($rowb = $resbank->fetch_assoc()){
    $resgtemp11 = $userObj->getEmployeeReportBankStatemant($emp,$tab_emp,$clintid,$bid,$frdt);
...
?>
	...
	<table width="100%">
	<tr>
	<td colspan="5" align="center">   Bank Statement For <?php echo date('F Y',strtotime($todt));?><br><?php echo $rowb['bank_name']." (".$rowb['branch'].") IFSC - " .$rowb['ifsc_code']?></td>
	</tr>
