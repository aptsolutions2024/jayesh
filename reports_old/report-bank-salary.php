...
{
  $sql11 = "select te.emp_id,te.netsalary,e.first_name,e.middle_name,e.last_name,te.bankacno from $tab_emp te inner join employee e on te.emp_id = e.emp_id  where te.comp_id ='".$comp_id."' AND te.user_id='".$user_id."' AND te.bank_id='".$row['mast_bank_id']."'  and te.client_id in (12,13,14,15,16) and te.sal_month = '$frdt' and te.netsalary > 0 and te.pay_mode = 'T' ORDER BY te.Client_id,te.bankacno,e.last_name,e.first_name,e.middle_name,e.Joindate ASC";
	
}
else{
  $sql11 = "select te.emp_id,te.netsalary,e.first_name,e.middle_name,e.last_name,te.bankacno from $tab_emp te inner join employee e on te.emp_id = e.emp_id  where te.comp_id ='".$comp_id."' AND te.user_id='".$user_id."' AND te.bank_id='".$row['mast_bank_id']."'  and te.client_id = '".$clintid."' and te.sal_month = '$frdt' and te.netsalary > 0 and te.pay_mode = 'T' ORDER BY te.Client_id,te.bankacno,e.last_name,e.first_name,e.middle_name,e.Joindate ASC";
}
    $res11 = mysql_query($sql11);
     $sql21 = "select sum(te.netsalary) as netsalary from $tab_emp te  where comp_id ='".$comp_id."' AND user_id='".$user_id."' AND bank_id='".$row['mast_bank_id']."' and client_id = '".$clintid."'   and te.sal_month = '$frdt' and te.pay_mode = 'T'";
                       ...
                       <table width = "90%">
                           ...
                           while ($rowemp = mysql_fetch_array($res11)) {
                               ...
                               <tr>
                                   ...
                                   <td><?php echo $row211['netsalary']; ?></td>
                               </tr>
