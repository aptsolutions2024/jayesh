...
function paginate($reload, $page, $tpages) {
    ...
    if ($page == 1) {
        ...
        $out.= "<li><a  href=\"?tpages=1\">&lsaquo;&lsaquo;</a><a  href=\"" . $reload . "\">" . $prevlabel . "</a>\n</li>";
    } else {
    ...
    // next
    if ($page < $tpages) {
        $out.= "<li><a  href=\"" . $reload . "&amp;page=" . ($page + 1) . "\">" . $nextlabel . "</a><a  href=\"?tpages=" . $tpages . "&page=".$tpages."\">&rsaquo;&rsaquo;</a>\n</li>";
    } else {
